...
export class Story extends Component {
    ...
    render() {
        ...
        const a = (user ? user.username : "")
        this.state.username = a
        const authorizedUser = <h2>yeet</h2>;
        ...
        return (
            <div className="card card-body mt-4 mb-4">
                ...
                <h2>
                    owner: {this.state.userStory.owner} {a} {this.state.username}
                    {console.log(a + 'username fuck')}
                </h2>
