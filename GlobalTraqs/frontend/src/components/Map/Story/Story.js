  ...
  return (
    <div className="container-fluid" style={storyBody}>
        <Row className={"down-arrow-row"}>
          <Col md={1} className="col-1" className={fixedArrow ? "fixed-down-icon-col" : "down-icon-col"}>
              <div>
              <Link
                to={"/"}
        ...
        <Row>
          ...
          {props.pin.is_anonymous_pin ? (
              <p className="sidebar-story-author">Posted by: <span className="sidebar-story-anon-username">Anonymous</span></p>
          ) : (
            <Link
