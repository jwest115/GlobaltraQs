                  ...
                  centered isOpen={true} toggle={toggle}>
                    ...
                    <ModalBody>
                      <Form onSubmit={this.onSubmit}>
                        ...
                        <FormGroup>
                            <Label style={labelStyle} for="radius">Anonymity radius</Label>
                              <select value={this.state.radius} onChange={this.handleRadiusChange}>
...
export default connect(mapStateToProps, { addPin })(CustomModal)